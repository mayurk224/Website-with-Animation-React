...
function Footer() {
  return (
    <div className="w-full h-screen px-10 pt-10">
      <div className="flex ">
        <div className="w-1/2">
          <h1 className="text-8xl w-96 font-bold">Eye-Opening</h1>
        </div>
        <div className="w-1/2">
          <h1 className="text-8xl font-bold">Presentation</h1>
          <div className="links mt-10">
            ...
            <div className="locationmobile flex gap-10">
              <div className="locationemail flex flex-col gap-5 w-1/2">
                <div className="location">
                  <h1>Location :</h1>
                  <ul className="mt-6">
                    <li className="mb-2">
                      <a href="">202-1965 W 4th Ave Vancouver, Canada</a>
                    </li>
                    <li>
                      <a href="">30 Chukarina St Lviv, Ukraine</a>
                    </li>
                  </ul>
                </div>
                <div className="email">
      ...
      <div className="footerbottom mt-[15vh]">
        <div className="flex w-full">
          ...
          <div className="destination w-1/2 flex items-center justify-center">
            <a href="" className="text-zinc-500">
              © ochi clone design 2024.{" "}
